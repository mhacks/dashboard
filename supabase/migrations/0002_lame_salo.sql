...
--> statement-breakpoint
ALTER TABLE "hacker_applicants" ADD COLUMN "airport_code" text;--> statement-breakpoint
...
ALTER TABLE "hacker_applicants" ADD COLUMN "review_notes" text;--> statement-breakpoint
ALTER TABLE "judge_applicants" ADD COLUMN "airport_code" text;