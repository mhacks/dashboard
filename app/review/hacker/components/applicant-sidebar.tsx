...
export function Sidebar({ apps, reviews, selectedId, onSelect, query, setQuery }: SidebarProps) {
  ...
  return (
    <div style={{
      width: 272, borderRight: "1px solid rgba(58,74,38,0.12)", display: "flex",
      flexDirection: "column", background: "#f0efe6", flexShrink: 0,
    }}>
      {/* Search + filters */}
      <div style={{ padding: "12px 14px", borderBottom: "1px solid rgba(58,74,38,0.12)" }}>
        <input
          value={query}
          onChange={(e) => setQuery(e.target.value)}
          placeholder="Search applicants…"
          style={{
            width: "100%", height: 32, borderRadius: 8, border: "1.5px solid rgba(58,74,38,0.2)",
            padding: "0 10px", fontSize: 12, fontFamily: "var(--font-geist-sans), system-ui",
            color: "#3A4A26", background: "#fff", outline: "none",
          }}
        />
        {/* Status filter pills */}
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: active ? "1.5px solid rgba(58,74,38,0.4)" : "1.5px solid rgba(58,74,38,0.15)",
        ...
        {filtered.map((app) => {
          ...
          return (
            <div
              ...
              onMouseEnter={(e) => { if (!sel) e.currentTarget.style.background = "rgba(58,74,38,0.05)" }}
            ...
            >
              ...
              <div style={{ fontSize: 11, color: "rgba(58,74,38,0.45)", paddingLeft: 14 }}>{app.university}</div>
              <div style={{ fontSize: 11, color: "rgba(58,74,38,0.45)", paddingLeft: 14 }}>
      ...
      {/* Footer stats */}
      <div style={{
        padding: "10px 14px", borderTop: "1px solid rgba(58,74,38,0.12)",
        fontSize: 11, color: "rgba(58,74,38,0.45)",
