...
export const mails: Mail[] = [
  {
    ...
    subject: makeSubject("University of Michigan", "Computer Science", "Bachelor's"),
    ...
    anythingElse: "I play violin in the university orchestra and love hackathon karaoke nights!",
  ...
  },
  {
    ...
    subject: makeSubject("Georgia Institute of Technology", "Computer Engineering", "Bachelor's"),
  ...
  },
  {
    ...
    subject: makeSubject("Massachusetts Institute of Technology", "Mathematics", "Bachelor's"),
    ...
    anythingElse: "I am a TA for 18.06 (Linear Algebra) and love making math accessible.",
  ...
  },
  {
    ...
    subject: makeSubject("University of Illinois at Urbana-Champaign", "Business", "Bachelor's"),
    ...
    whyAttend: "I want to attend to learn about technology and meet developers.",
    technicalChallenge: "I had to fix a bug in a spreadsheet formula at my internship.",
    proudProject:
  ...
  },
  {
    ...
    subject: makeSubject("Carnegie Mellon University", "Computer Science", "Master's"),
