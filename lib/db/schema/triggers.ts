...
// Referenced by events.updated_at trigger in custom migration
// 20260825000000_events_triggers.sql.
export const eventsSetUpdatedAtTriggerName = "events_set_updated_at";
