...
export const applicationSchema = z.object({
  ...
  proudProject: z
    ...
    .min(100, "Please write at least 100 characters")
    .max(1000, "Please limit your response to 1000 characters"),
  anythingElse: z.string().max(1000, "Please limit your response to 1000 characters").optional(),
  ...
  personalSite: z.string().url("Please enter a valid URL").optional().or(z.literal("")),
  ...
  mlhPrivacyPolicy: z.boolean().refine((val) => val === true, "You must agree to share your information with MLH"),
  mlhEmails: z.boolean().refine((val) => val === true, "You must agree to receive emails from MLH"),
